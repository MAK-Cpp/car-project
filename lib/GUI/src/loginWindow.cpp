...
//QLabel loginWindow::login_ = "Имя пользователя:";
//QLabel loginWindow::password_ = "Пароль:";
...
//    login_input_.setFixedWidth(this->width() / 2);
//    password_input_.setFixedWidth(this->width() / 2);
